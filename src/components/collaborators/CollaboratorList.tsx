...
/**
 * Derive a display-friendly "time since invited" string from a Collaborator's
 * `createdAt` field. Handles both Firestore Timestamp objects and serialised
 * date strings gracefully.
 */
function getTimeSinceInvited(collaborator: Collaborator): string {
  try {
    const createdAt = collaborator.createdAt;
    const date = createdAt && typeof (createdAt as any).toDate === 'function'
      ...
      {collaborators.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="mt-1 text-sm text-slate-500 max-w-xs">
            Invite clients, subcontractors, or team members to collaborate on
            this project.
          </p>
        ...
        <div className="space-y-2">
          {collaborators.map((collaborator) => {
            ...
            const timeSinceInvited = getTimeSinceInvited(collaborator);
